...
export default class EditUsrMgmt extends Component{
    constructor(props){
        super(props);
        ...
        <div >
          ...
          <ul className="usrmgmt_content">
            ...
            <li>
              ...
              <Input  className="usrmgmt_input" size="large" placeholder="隶属单位" />
              <span className="usrmgmt_span">密码</span>
              <Input  className="usrmgmt_input" size="large" placeholder="密码" />
