...
export default class Log extends Component {
  ...
  changeRoleName(date, dateString) {
    let apply = this.state.applyPage;
    apply.roleName = dateString;
    this.setState({
      applyPage: apply
    })
  }
      ...
      <div>
        <div className="apple_top">
          ...
          <ul className="search_ul">
            <li>
              <span className="most_flex">操作人</span>
            ...
            <li>
              <span className="most_flex">操作时间</span>
              <DatePicker onChange={this.changeRoleName.bind(this)} className="search_input" size="large"
                          placeholder="操作时间"/>
            </li>
            <li>
