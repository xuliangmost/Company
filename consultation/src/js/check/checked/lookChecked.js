        ...
        return (
            <div className="newHidden">
                ...
                <div className="cnsultation_bottom">
                    ...
                    {
                        this.state.history1 != false ? <div
                            className="history_detail">{/*这里循环一个state，点击病历就切换this.setState   点击新增就让新增的这个id去setState */}
                            <ul className="search_ul">
                                <li>
                            ...
                            <ul className="search_ul2">
                                <li>
                                    ...
                                    <Input value={this.state.history1.diagnosis} className="search_input"
                                           type="textarea" rows={4}/>
                                </li>
                            </ul>
                        </div> : ""
