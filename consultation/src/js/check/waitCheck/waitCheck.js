        ...
        this.state = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    render: (text, record, index) => (
                        <span key={record.id}>
              <Link to={"check/waitCheck/lookWaitCheck/" + record.id}>审核</Link>
                ...
                <div className="apple_top">
                    ...
                    <ul className="search_ul">
                        <li>
                            ...
                            <Input value={this.state.applyPage.title} onChange={this.changeConsultationName.bind(this)}
                        ...
                        <li>
                            ...
                            <Input value={this.state.applyPage.applyName} onChange={this.changeUser.bind(this)}
                                   className="search_input" size="large" placeholder="申请人"/>
                        </li>
                        <li>
