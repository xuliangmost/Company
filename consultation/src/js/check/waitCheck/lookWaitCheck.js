                ...
                <div className="cnsultation_top">
                    ...
                    <ul className="search_ul">
                        <li>
                            ...
                            <Input value={this.state.getData.consultation.hospitalname} className="search_input"
                                   size="large" placeholder="隶属医院"/>
                        </li>
                        <li>
                            <span className="most_flex">会诊申请人</span>
                            <Input value={this.state.getData.consultation.applyName} className="search_input"
                                   size="large" placeholder="会诊申请人"/>
                        </li>
                        <li>
                            <span className="most_flex">会诊名称</span>
                            <Input value={this.state.getData.consultation.consultationName} className="search_input"
                                   size="large" placeholder="会诊名称"/>
                        </li>
                        <li>
                            <span className="most_flex">会诊时间</span>{/*这里要加上一个判断， 判断不为空*/}
                            <DatePicker open={false} allowClear={false} onChage={() => this.startTime()}
                ...
                <div className="cnsultation_bottom">
                    ...
                    <div className="history_detail">{/*这里循环一个state，点击病历就切换this.setState   点击新增就让新增的这个id去setState */}
                        ...
                        <ul className="search_ul2">
                            <li>
                                ...
                                <Input value={this.state.history1.diagnosis} className="search_input" type="textarea"
                                       rows={4}/>
                            </li>
                        </ul>
                    </div>
...

                    {
                        ...
                        this.state.conclusion.length > 0 ? <ul className="search_ul2">
                            <li className="search_li_last">
                                ...
                                <Table  rowKey="id"  className="search_input" columns={this.state.conclusionColumns}
                                       dataSource={this.state.conclusion}/>
                            </li>
                        </ul> : ""
                    }
                    ...
                    <div className="btn_save">
                        <div className="btn_save_index">
                            <div className="btn_div1">
                                ...
                                <Button type="primary" disabled={this.state.hadResolve}
                                        onClick={() => this.tuihuiDiv()}>标记退回</Button>&nbsp;
                            </div>
                            <div className="btn_div1">
...

                    {
                        this.state.isShowBiaoji ? <div className="returnDiv">
                            <Input type="textarea" value={this.state.returnReason}
                                   onChange={this.changeReturn.bind(this)} rows={4} placeholder="请输入退回原因"/>
                            <div className="btn_return_div">
                                <Button type="primary" className="btn_one"
                                        onClick={() => this.conFirmReturn()}>确认退回</Button>&nbsp;
