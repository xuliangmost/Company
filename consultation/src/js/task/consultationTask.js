                ...
                <div className="apple_top">
                    ...
                    <ul className="search_ul">
                        ...
                        <li>
                            ...
                            <Input value={this.state.applyPage.applicant} onChange={this.changeApplicant.bind(this)}
                                   className="search_input" size="large" placeholder="申请人"/>
                        </li>
                        <li>
                            <span className="most_flex">手机号</span>
                            <Input value={this.state.applyPage.aPhone} onChange={this.changeaPhone.bind(this)}
                                   className="search_input" size="large" placeholder="手机号"/>
                        </li>
                        <li>
