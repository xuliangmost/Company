        ...
        <div className="cnsultation_top">
          ...
          <ul className="search_ul">
            <li>
              ...
              <Input  value={this.state.getData.consultation.phone} onBlur={this.checkUserId.bind(this)}  className="search_input" size="large" placeholder="必填" onChange={this.changePhone.bind(this)}   />
            </li>
            <li>
              <span className="most_flex">会诊对象</span>
              <Input  value={this.state.getData.consultation.username}  className="search_input" size="large" placeholder="必填" onChange={this.changeUsername.bind(this)}  />
            </li>

            <li>
              <span className="most_flex">身份证号</span>
              <Input  value={this.state.getData.consultation.identification}  className="search_input" size="large" placeholder="必填" onChange={this.changeIdentification.bind(this)}  />
            </li>
            <li>
          ...
          <ul className="search_ul">
            <li>
              ...
              <Input  value={this.state.getData.consultation.famliyName}  className="search_input" size="large" placeholder="陪护家属"   onChange={this.changeFamliyName.bind(this)}/>
            </li>
            <li>
              <span className="most_flex">手机号</span>
              <Input  value={this.state.getData.consultation.familyPhone}  className="search_input" size="large" placeholder="手机号"  onChange={this.changeFamilyPhone.bind(this)} />
            </li>
          ...
          <ul className="search_ul2">
            <li>
              ...
              <Input  value={this.state.getData.consultation.content} className="search_input" type="textarea" rows={4}   onChange={this.changeContent.bind(this)}/>
            </li>
          </ul>
          ...
          <div className="history_detail">{/*这里循环一个state，点击病历就切换this.setState   点击新增就让新增的这个id去setState */}
            ...
            <ul className="search_ul">
              ...
              <li>
                ...
                <DatePicker format={dateFormat} size="large" className="search_input"  placeholder="必填"  onChange={this.changeDagnosisTime.bind(this)} />
              </li>
            </ul>
            ...
            this.state.history2?<div className="prescribeDetail">
              <ul className="search_ul">
                <li>
                  ...
                  <Input value={this.state.history2.hospital?this.state.history2.hospital:""} onChange={this.changeAdviceHospital.bind(this)} className="search_input"  placeholder="必填"  size="large"  />
                </li>
                <li>
