          ...
          <div className="history_detail">{/*这里循环一个state，点击病历就切换this.setState   点击新增就让新增的这个id去setState */}
            <ul className="search_ul">
              <li>
                ...
                <Input value={this.state.history1.sn} className="search_input" size="large" placeholder="病例编号" onChange={this.changeSn.bind(this)} />
              </li>
              <li>
              </li>
            ...
            <ul className="search_ul">
              <li>
                ...
                <Input value={this.state.history1.hospital} className="search_input" size="large" placeholder="病例医院" onChange={this.changeHospital.bind(this)}  />
              </li>
              <li>
