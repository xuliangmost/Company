                ...
                <div className="cnsultation_top">
                    ...
                    <ul className="search_ul">
                        ...
                        <li>
                            ...
                            <DatePicker showTime open={false} allowClear={false}
                        ...
                        <ul className="search_ul">
                            <li>
                                ...
                                <Input value={this.state.history1.sn} className="search_input" size="large"
                                       placeholder="病例编号" onChange={this.changeSn.bind(this)}/>
                            </li>
                            <li>
                            </li>
                        ...
                        <ul className="search_ul">
                            <li>
                                ...
                                <Input value={this.state.history1.hospital} className="search_input" size="large"
                                       placeholder="病例医院" onChange={this.changeHospital.bind(this)}/>
                            </li>
                            <li>
                            ...
                            <ul className="search_ul">
                                ...
                                <li>
                                    ...
                                    <DatePicker allowClear={false}
                                                ...
                                                format={dateFormat} size="large" className="search_input"
                                                onChange={this.changeAdviceTime.bind(this)}/>
                                </li>
                                <li>
                                </li>
                            </ul>
