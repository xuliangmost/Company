...
////////////
    ...
    saveCase() {//保存病历
        ...
        axios.request({
            ...
            postCase.id = response.data.id ? response.data.id : postCase.id;
    ...
    send() {
        if (this.state.saveCase) {
            if (this.state.saveAdvice) {
                if (this.state.selectDoctor.length === 0) {
                    alert("会诊医生未选择!");
                    return false
                }
                axios.request({
                            ...
                            <ul>
                                <li>
                                    ...
                                    <DatePicker allowClear={false} showTime format={dateFormat}
                                                onChange={this.changePrescriptionTime.bind(this)} placeholder="必填"
                                                size="large"/>
                                </li>
                                <li>
                                    <span>开方医生姓名</span>
                ...
                <div className="cnsultation_top">
                    ...
                    <ul className="search_ul">
                        ...
                        <li>
                            ...
                            <DatePicker open={false} allowClear={false}
