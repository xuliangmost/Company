...
/////////////////////////
    ...
    getValue() {
        ...
        axios.request({
            ...
            that.setState({
                ...
                hIds,
                consultationId:that.props.params.id,
    ...
    checkUserId() {
        ...
        let oldPhone = this.state.oldPhone;
        axios.request({
            ...
            if (parseFloat(data) == parseFloat(that.state.oldPhone)) {
            } else {
                caseId = true;
                getData.case = allData.case;
                getData.case[0].advice[0].prescription ? getData.case[0].advice[0].prescription.map((ele) => {
    ...
    saveConsulation() {//保存会诊
        let postConsulation = this.state.getData.consultation;

        if (tool.isEmpty(postConsulation.consultationName)) {
            alert("会诊名称不能为空!");
            return false
        }
        ...
        if (tool.isEmpty(postConsulation.username)) {
            alert("会诊对象不能为空!");
            return false
        }
            ...
            <div style={this.state.showPrescription ? Hidden : this.state.isShow ? Hidden : null} className="newHidden">
                    ...
                    this.state.showPrescription ? <div style={style} className="Prescription">
                        <div className="showPrescription">
                            <ul>
                                <li>
                                    <span>开方时间</span>
                                    <DatePicker allowClear={false} showTime format={dateFormat}
                ...
                <div className="cnsultation_top">
                    ...
                    <ul className="search_ul">
                        ...
                        <li>
                            ...
                            <DatePicker showTime allowClear={false}
                                        ...
                                        onChange={this.changesStartTime.bind(this)}/>
                    ...
                    <ul className="search_ul">
                        ...
                        <li>
                            ...
                            <DatePicker placeholder="必填" allowClear={false}
                ...
                <div className="btn_save">
                    <div className="btn_save_index">
                        <Button disabled={this.state.dis} onClick={this.saveConsulation.bind(this)}
                            ...
                            <ul className="search_ul">
                                ...
                                <li>
                                    ...
                                    <DatePicker allowClear={false}
                                                ...
                                                placeholder="必填" format={dateFormat} size="large"
